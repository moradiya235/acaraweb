...
function Contact1() {
  return (
    <Box>
    <Box sx={{backgroundImage:`linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)),url(${img18})`,height:"100vh",width:"100%",backgroundPosition:"center",objectFit:"cover",backgroundSize:"cover"}}>
         <Box>
             <Typography variant='h3' sx={{color:"white",paddingTop:"420px",fontWeight:"bold",display:"flex",justifyContent:"center",alignItems:"center"}}>
                 Contact Us
             </Typography>
         </Box>
    ...
    <Container>
              <Box >
                   <Typography variant='h4' sx={{marginTop:"100px",display:"flex",justifyContent:"center",fontWeight:"600"}}>Get It Touch</Typography>
                   <Typography sx={{marginTop:"25px",color:"#64656C",display:"flex",justifyContent:"center",fontWeight:"500"}}>Vestibulum accumsan scelerisque dolor quam id quam tempor adipiscing nibh vulputate aenean integer sapien</Typography>
                   <Typography sx={{lineHeight:"35px",color:"#64656C",display:"flex",justifyContent:"center",fontWeight:"500"}}>scelerisque arcu nunc nulla elementum tincidunt aliquam auctor vehicula viverra pulvinar porttitor.</Typography>   
    ...
    <Grid item xs={12}  container  sx={{display:"flex",width:"100%",paddingTop:"50px",justifyContent:{md:"center",lg:"center",xs:"center",sm:"center"}}}>
            <Grid item xs={12} sm={8} md={6} lg={4} sx={{display:"flex",justifyContent:"center"}}>
            ...
            <Grid item xs={12} sm={8} md={6} lg={6} sx={{display:"flex",justifyContent:"center"}} py={5}>
                    ...
                    <Box sx={{ width:"100%",backgroundColor:"black",height:"100%"}}>
                         <Box sx={{display:"flex",marginLeft:"30px",marginTop:"30px",marginRight:"30px"}}>
                          <Typography sx={{color:"#5F656C"}}>Name</Typography>
                         ...
                         <TextField fullWidth placeholder="Full name" id="fullWidth" sx={{ backgroundColor: "white", height: '40px','& .MuiInputBase-root': {height: '100%'}}}/>
                           ...
                           <Box sx={{display:"flex",marginLeft:"30px",marginTop:"30px",marginRight:"30px"}}>
                          <Typography sx={{color:"#5F656C"}}>Company </Typography>
                          <Typography sx={{color:"red",fontSize:"20px",paddingLeft:"5px"}}> * </Typography>
                         </Box>
                         ...
                         <TextField fullWidth placeholder="Company name" id="fullWidth" sx={{ backgroundColor: "white", height: '40px','& .MuiInputBase-root': {height: '100%'}}}/>
                           ...
                           <Box sx={{display:"flex",marginLeft:"30px",marginTop:"30px",marginRight:"30px"}}>
                          <Typography sx={{color:"#5F656C"}}>Email address</Typography>
                          <Typography sx={{color:"red",fontSize:"20px",paddingLeft:"5px"}}> * </Typography>
                         </Box>
                         ...
                         <TextField fullWidth placeholder="Email address" id="fullWidth" sx={{ backgroundColor: "white", height: '40px','& .MuiInputBase-root': {height: '100%'}}}/>
                           ...
                           <Box sx={{display:"flex",marginLeft:"30px",marginTop:"30px",marginRight:"30px"}}>
                          <Typography sx={{color:"#5F656C"}}>message</Typography>
                          <Typography sx={{color:"red",fontSize:"20px",paddingLeft:"5px"}}> * </Typography>
                         </Box>
